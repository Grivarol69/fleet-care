  ...
  useEffect(() => {
    const fetchingTypes = async () => {
      try {
        ...
        // filtro documentos por placa del vehiculo
        const documentsByPlate = response.data.filter(
          (docs: Document) => docs.vehiclePlate === vehicle.licensePlate
        );
        // setDocuments(response.data);
        setDocuments(documentsByPlate);
      } catch (error) {
