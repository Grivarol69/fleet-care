...
import { formSchema } from "./FormEditItemPlanVehicle.form";
import {
...
export function FormEditItemPlanVehicle({
  isOpen,
  setIsOpen,
  itemPlanVehicle,
  onEditItemPlanVehicle,
}: FormEditItemPlanVehicleProps) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      mantItemId: itemPlanVehicle.mantItemId,
      providerId: itemPlanVehicle.providerId,
      startDate: itemPlanVehicle.startDate,
      endDate: itemPlanVehicle.endDate,
      cost: itemPlanVehicle.cost,
      actualDuration: itemPlanVehicle.actualDuration,
      executionMileage: itemPlanVehicle.executionMileage,
      notes: itemPlanVehicle.notes,
      state: itemPlanVehicle.state,
    },
  });
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const response = await axios.patch(
        `api/mantenaince/item-plan-vehicle/${itemPlanVehicle.id}`,
        {
      ...
      onEditItemPlanVehicle(response.data);
      setIsOpen(false);
      form.reset();
      toast({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Agregar Nueva Relación Proveedor Mant Item</DialogTitle>
        </DialogHeader>
        <Form {...form}>
