...
import { formSchema } from "./FormAddItemPlanVehicle.form";
import {
...
export function FormAddItemPlanVehicle({
  isOpen,
  setIsOpen,
  onAddItemPlanVehicle,
}: FormAddItemPlanVehicleProps) {
  ...
  // Estado local para manejar el valor formateado
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const response = await axios.post(`api/mantenaince/item-plan-vehicle`, {
      ...
      onAddItemPlanVehicle(response.data);
      setIsOpen(false);
      form.reset();
      toast({
